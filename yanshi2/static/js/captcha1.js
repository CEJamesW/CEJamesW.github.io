						...
						if (k.length == g.length) {
							...
							a.ajax({
								...
								if(c==10010){
									...
									captcha_error_info = "验证码今天错误次数太多,请明天再来！";
									a("#clicaptcha-box .clicaptcha-title").html(captcha_error_info);
									a("#clicaptcha-box .clicaptcha-refresh-btn").attr("disabled",true).css("pointer-events","none");
									return false;
								}
								else{
