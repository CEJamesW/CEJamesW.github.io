...
var stui = {
	...
	'common': {//公共基础
		...
		/*'share': function(){
			...
			window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName("head")[0]||body).appendChild(createElement('script')).src='/template/stui_tpl/statics/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
		}*/
	}	
};
